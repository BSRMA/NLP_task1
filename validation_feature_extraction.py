...
def save_csv(text, name, folder_path):
  ...
  validation_feat_file_name = name+'.csv'
  validation_feat_file_path = os.path.join(folder_path, validation_feat_file_name)
  df.to_csv(validation_feat_file_path, escapechar='\\')
  
  
annual_report_path = 'validation/annual_reports'
contents1 = os.listdir(annual_report_path)
j = 0

folder_path = "DATA/validation_features"
try:
